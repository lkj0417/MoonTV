    ...
    try {
      ...
      if (type === 'custom') {
        ...
        data = await getDoubanRecommends({
          ...
          region:
            multiLevelValues.region !== 'all' ? multiLevelValues.region : '',
          year: multiLevelValues.year !== 'all' ? multiLevelValues.year : '',
          platform:
            multiLevelValues.platform !== 'all'
              ? multiLevelValues.platform
              : '',
          sort: multiLevelValues.sort !== 'T' ? multiLevelValues.sort : '',
          label: multiLevelValues.label !== 'all' ? multiLevelValues.label : '',
        });
        ...
        data = await getDoubanRecommends({
          ...
          pageStart: 0,
          category:
            multiLevelValues.type !== 'all' ? multiLevelValues.type : '',
            ...
            data = await getDoubanRecommends({
              ...
              region:
                multiLevelValues.region !== 'all'
                  ...
                  : '',
              year:
                multiLevelValues.year !== 'all' ? multiLevelValues.year : '',
              platform:
                multiLevelValues.platform !== 'all'
                  ? multiLevelValues.platform
                  : '',
              sort: multiLevelValues.sort !== 'T' ? multiLevelValues.sort : '',
              label:
                multiLevelValues.label !== 'all' ? multiLevelValues.label : '',
            });
          } else if (primarySelection === '全部') {
            data = await getDoubanRecommends({
              kind: type === 'show' ? 'tv' : (type as 'tv' | 'movie'),
