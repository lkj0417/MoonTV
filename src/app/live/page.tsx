...
import { ChevronDown, Radio, RefreshCw, Search, Tv } from 'lucide-react';
...
function LivePageClient() {
  ...
  const loadChannels = useCallback(async (source: LiveSource) => {
    ...
    try {
      ...
      const liveChannels: LiveChannels | null = await getCachedLiveChannels(
        source.key
      );
